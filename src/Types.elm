...
-- type Token = TSCInt TokTSCInt | TSCBool TokTSCBool | TokAssign | TokLParen | TokRParen | TokHole | TokVar String | TokConstInt Int | TokConstBool Bool | TokInvalid | TokEnd
-- type TokTSCInt = TokPlus | TokMinus | TokTimes 
-- type TokTSCBool = TokEq | TokAnd | TokOr 
